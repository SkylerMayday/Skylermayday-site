...
const BASE_CLASSES =
  "flex flex-col gap-2 rounded-lg border border-neutral-200 p-6 dark:border-neutral-800";
 ...
 * past projects. The Discord bot card is NOT rendered through this (it has a
 * live status widget and stays bespoke in the page).
 */
export default function ProjectCard({
  ...
  const className = [BASE_CLASSES, muted && MUTED_CLASSES, href && LINK_CLASSES]
    .filter(Boolean)
    .join(" ");
